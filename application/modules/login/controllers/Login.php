...
class Login extends CI_Controller {
    ...
    private function _sendEmail($token, $type){
        $config = [
            ...
            'smtp_user'  => 'astore0707@gmail.com',
            'smtp_pass'  => 'iyas4646',
            'smtp_port'  => 465,
            'mailtype'   => 'html',
            'charset'    => 'utf-8',
        ...
        $this->email->from('kopiqucoffee@gmail.com', 'A Store OFFICIAL');
        $this->email->to($this->input->post('email'));

        if($type == 'verify'){
            $this->email->subject('Verifikasi akun | My Account A Store');
            $this->email->message(
                'Klik verifikasi akun untuk mengaktifkan <b>My Account A Store</b> anda.<br>
